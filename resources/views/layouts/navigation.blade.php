<nav x-data="{ open: false }" class="bg-blue-400">
    ...
    <div class="max-w-7xl pt-5 sm:px-6 lg:px-8">
        <div class="block h-16">
            <div class="block">
                <!-- Logo -->
                {{-- <div class="block-shrink-0 block items-center">
                    <a href="{{ route('home') }}">
                    ...
                    <x-dropdown align="left" width="50">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                <img src="{{asset('img/avatar1.jpg')}}" class="rounded mr-2" width="48" alt="">
                                <div class="mr-1">{{ Auth::user()->nom }}</div>
