        ...
        <form action="{{ route('image.store' ) }}" method="post"
            ...
            <div class="grid grid-cols-2 mt-5 mx-7">
                ...
                <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Nom de le
                        l'image</label>
                    <input
                ...
                <div>
                    <label
                        class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">categories</label>
            ...
            <div class="grid grid-cols-2 mt-5 mx-7">
                {{-- INPUT FILE --}}
                <div>
                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Image
                        file</label>
                    <input
